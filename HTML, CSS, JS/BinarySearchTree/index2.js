 ...
 */
 class BSTNode {
  ...
  class BinarySearchTree {
    ...
    insert(newVal) {
        ...
        while (current.left != null || current.right != null) { //run while next node != null
            
            //go to next branch according to newVal
        ...
        //check if newVal is > or < current node and set newVal
        if (newVal < current.data) {
  ...
  */
  ...
  console.log(twoLevelTree.insert(14));
  /* fullTree
                      root
                  <-- 25 -->
                /            \
